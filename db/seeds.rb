...
# Get _gunk/sitemap.yml
require 'yaml'
classes = YAML.load(File.new("#{Rails.root}/_gunk/sitemap.yml"))

# Default Pages from _gunk/sitemap.yml
puts "\n============\nBUILDING PAGES"
...
# Default Post Categories from _gunk/sitemap.yml
puts "\n============\nPOST CATEGORIES"
